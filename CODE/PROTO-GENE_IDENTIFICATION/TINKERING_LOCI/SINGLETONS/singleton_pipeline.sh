...
python cluster_isoforms_products_aggregate.py allfeature_reads_F_out_gffinfo_TLREADSONLY_analysis_withreads_CODINGORFS_DAFF_SPECIFIC_SINGLETONSONLY allfeature_reads_M_out_gffinfo_TLREADSONLY_analysis_withreads_CODINGORFS_DAFF_SPECIFIC_SINGLETONSONLY  >> SUMMARY_OUTFILE
