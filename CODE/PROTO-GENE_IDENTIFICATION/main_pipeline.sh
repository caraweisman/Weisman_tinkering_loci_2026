...
python find_chimera_reads.py allfeature_reads_M_out_gffinfo_TLREADSONLY TL_reads_M.fna_TS_STRANDS 
python find_chimera_reads.py allfeature_reads_F_out_gffinfo_TLREADSONLY TL_reads_F.fna_TS_STRANDS
...
python -u protein_search.py allfeature_reads_M_out_gffinfo_TLREADSONLY_analysis_withreads TL_reads_M.fna_ORIENTED_m_esltrans "$refproteome"
python -u protein_search.py allfeature_reads_F_out_gffinfo_TLREADSONLY_analysis_withreads TL_reads_F.fna_ORIENTED_m_esltrans "$refproteome"

# extract rows with proteins that are only present in affinis based on conservation analysis
python coding_conservation.py allfeature_reads_M_out_gffinfo_TLREADSONLY_analysis_withreads_CODINGORFS "$consfile" PROT_LENGTH_INFO_TL_reads_M.fna_ORIENTED_m_esltrans
python coding_conservation.py allfeature_reads_F_out_gffinfo_TLREADSONLY_analysis_withreads_CODINGORFS "$consfile" PROT_LENGTH_INFO_TL_reads_F.fna_ORIENTED_m_esltrans
